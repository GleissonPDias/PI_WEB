...
if (empty($dados)) {
    ...
    foreach ($dados as $produtos) { 
        ...
        echo "<td><button type='button' class='btn_acao editar' onclick='editarSubCategoria(\"" . $produtos['id'] . "\", \"" . addslashes($produtos['nome']) . "\")'>Editar</button></td>";
        echo "<td><button type='button' class='btn_acao apagar' onclick='apagarSubCategoria(\"" . $produtos['nome'] . "\")'>Apagar</button></td>";
