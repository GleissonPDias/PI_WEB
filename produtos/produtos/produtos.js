...
const loceditar = (id) => {
  ...
  fetch("editar/localizaredit.php", {
    ...
    .then((data) => {
      ...
      prodloc.innerHTML = data;
    })
    .catch((error) => {
      console.error("Erro:", error);
      prodloc.innerHTML = "Ocorreu um erro ao carregar os produtos.";
    });
};
...
const locategoria = (nome) => {
  ...
  fetch("categorias/localizarcategorias.php", {
    ...
    .then((data) => {
      catlocalizada.innerHTML = data;
    })
    .catch((error) => {
      console.error("Erro:", error);
      catlocalizada.innerHTML = "Ocorreu um erro ao carregar os produtos.";
    });
};
...
const editar = (id) => {
  ...
  fetch("editar/editar.php", {
    ...
    body: `id=${encodeURIComponent(id)}&nomeproduto=${encodeURIComponent(
      nomeproduto
    )}&preco=${encodeURIComponent(preco)}&descricao=${encodeURIComponent(
      descricao
    )}&estoque=${encodeURIComponent(estoque)}&categoria=${encodeURIComponent(
      categoria
...
const addproduto = () => {
  ...
  fetch("cadastro/cadastroproduto.php", {
    ...
    body: `nomeproduto=${encodeURIComponent(
      nomeproduto
    )}&preco=${encodeURIComponent(preco)}&descricao=${encodeURIComponent(
      descricao
    )}&estoque=${encodeURIComponent(estoque)}&categoria=${encodeURIComponent(
...
const subcategorias = () => {
  ...
  let subcategoriaslocalizadas = document.getElementById(
    "subcategoriaslocalizadas"
  );
...
const adicionarcategoria = () => {
  const novacategoria = document
    .getElementById("categoria-adicionar")
    .value.toUpperCase();
...
const adicionarsubcategoria = () => {
  const novasubcategoria = document
    .getElementById("subcategoria-adicionar")
    .value.toUpperCase();
  ...
  fetch("cadastro/cadastrosubcategoria.php", {
    ...
    body: `novasubcategoria=${encodeURIComponent(
      novasubcategoria
    )}&id_categoria=${encodeURIComponent(id_categoria)}`,
  })
    .then((response) => response.json()) // Processa a resposta como JSON
    .then((data) => {
      if (data.message) {
...
const apagarCategoria = (nome) =>
  apagarCategorias(nome, "categorias/excluircategoria.php");
const apagarSubCategoria = (nome) =>
  apagarCategorias(nome, "categorias/excluirsubcategoria.php");
...
function editarCategoria(id, nomeAtual) {
  ...
  if (novoNome && novoNome.trim() !== "") {
    fetch("categorias/renomearcategoria.php", {
      ...
      body: `categoria=${encodeURIComponent(id)}&novonome=${encodeURIComponent(
        novoNome.toUpperCase()
      )}`,
    })
      .then((response) => response.json())
      .then((data) => {
...
function aplicarFiltros() {
  ...
  fetch("pagina/filtroprodutos.php", {
    ...
    body: `categoria=${encodeURIComponent(
      categoria
    )}&subcategoria=${encodeURIComponent(
      subcategoria
    )}&preco=${encodeURIComponent(preco)}&nome=${encodeURIComponent(
      nome
